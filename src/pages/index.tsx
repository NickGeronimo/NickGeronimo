...
<header className="sticky bg-main top-0 z-10 shadow-lg bg-dark-accent">
    <section className="max-w-4xl mx-auto p-4 flex justify-between items-center text-light-shade">
...
Nicholas Geronimo</a></h1>
      ...
      <section id="mobile-menu" className="absolute top-68 bg-dark-shade w-full text-5xl flex-col justify-content-center origin-top animate-open-menu hidden">
  ...
  <main className="max-w-4xl mx-auto">
    <section id="hero" className="flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-8 mb-12 scroll-mt-40 tallscreen:section-min-height widescreen:section-min-height">
      <article className="sm:w-1/2">
        <h2 className="max-w-md text-4xl font-bold text-center  sm:text-5xl sm:text-left text-light-shade">
          Hello! My Name Is <span className="">Nick</span> 
        </h2>
      </article>
      <img src="./ng.png" alt="Picture" className="rounded-full md:rounded-bl-none border border-solid border-main-color" />
    </section>
    ...
    <section id="skills" className="p-6 my-12 scroll-mt-20 tallscreen:section-min-height widescreen:section-min-height">
      ...
      <ul className="list-none grid gap-4 grid-cols-2 md:grid-cols-4 w-full max-w-screen-lg">
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Shopify</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Github</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Google Tag Manager</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Google Analytics</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">HTML5</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">CSS</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">JavaScript</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">PHP</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">MongoDB</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Express</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">React</h3> </li> 
          <li className="border border-solid border-main-color  bg-dark-accent py-6 px-2 rounded-3xl shadow-xl"><h3 className="text-lg text-center text-white">Node</h3> </li> 
  ...
  <footer id="footer" className="bg-slate-950 text-white text-xl border-t shadow-lg shadow-white">
